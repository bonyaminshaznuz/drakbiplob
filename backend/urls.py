...
urlpatterns = [
    ...
    path('accounts/login/', appointment_views.admin_login, name='admin-login'),
    path('accounts/logout/', auth_views.LogoutView.as_view(next_page='admin-login'), name='logout'),
