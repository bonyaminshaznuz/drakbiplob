                ...
                <div className="container mx-auto px-4 sm:px-6">
                    <div className="flex flex-wrap items-center justify-center sm:justify-start gap-3 sm:gap-4 md:gap-8">
                        ...
                        <div className="flex items-center gap-2 hover:text-accent transition">
                            ...
                            <span className="font-medium hidden sm:inline">akbiplob36@gmail.com</span>
                    ...
                    <div className="flex items-center justify-between">
                        <Link to="/" onClick={handleHomeClick} className="flex items-center gap-2 sm:gap-3 group cursor-pointer">
                            <div
                                ...
                                <i className="fas fa-stethoscope text-lg sm:text-xl text-white"></i>
                            </div>
                            <div>
                                <span className="text-base sm:text-xl font-bold text-primary block">Dr. Abul Khayer (Biplob)</span>
                                <span className="text-[10px] sm:text-xs text-gray-500 hidden sm:block">Anaesthetist, Intensivist & Pain Physician</span>
                            </div>
                        </Link>
